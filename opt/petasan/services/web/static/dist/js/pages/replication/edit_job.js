...
$(document).ready(function () {
    ...
    if ($("#pre_snap_script").val() || $("#post_snap_script").val() || $("#post_job_complete").val()) {
...
$("#addJob_form").submit(function (event) {
    ...
    if (!jobNameValue) {
        $("#lblJobName").text(messages.edit_job_lbl_name_empty);
    ...
    if (backup_node_value == "") {
        $('#lblUseNode').text(messages.edit_job_lbl_Use_node_null);
    ...
    if (!source_disk_value) {
        $("#lblSourceDisk").text(messages.edit_job_lbl_src_iscsi_empty);
    ...
    if (!dest_cluster_name_value) {
        $("#lblDestinationName").text(messages.edit_job_lbl_dest_cluster_name_empty);
    ...
    if (!destination_disk_value) {
        $("#lblIDestinationDisk").text(messages.edit_job_lbl_dest_iscsi_empty);
    ...
    if (!selected_schedule_value) {
        $("#lblSchedule").text(messages.edit_job_lbl_schedule_required);
